...
const RecuperarContrasena = () => {
    ...
    const handlePasswordChange = (e: React.ChangeEvent<HTMLInputElement>) => {
        setNuevaPassword(e.currentTarget.value);
    };

    const handleConfirmPasswordChange = (e: React.ChangeEvent<HTMLInputElement>) => {
        setConfirmNuevaPassword(e.currentTarget.value);
    };
        ...
        <div className="d-flex flex-column justify-content-center align-items-center w-100 py-4">
            ...
            <div className="text-center mb-4">
                ...
                <p style={{ color: "rgba(255, 255, 255, 0.6)", fontSize: "0.95rem" }}>
                    Recuperación de Acceso a su Perfil
                </p>
            </div>
            ...
            <div className="glass-card">
                {!enlaceEnviado ? (
                    ...
                    <>
                        <h4 className="fw-bold mb-1 text-start" style={{ color: "#ffffff" }}>Recuperar cuenta</h4>
                        ...
                        <form onSubmit={handleRequestSubmit}>
                            ...
                            <div className="text-center mt-3">
                                <a
                                    ...
                                    style={{ color: "#74C3D2", fontSize: "0.85rem" }}
                                    onClick={(e) => {
                                        e.preventDefault();
                                        navigate("/");
                                    }}
                    ...
                    // Paso 2: Restablecer Contraseña (Simulador)
                    <div className="text-start">
                        ...
                        <h4 className="fw-bold mb-2" style={{ color: "#ffffff" }}>Enlace enviado</h4>
                    ...
                    <div className="text-start">
                        ...
                        <h4 className="fw-bold mb-2" style={{ color: "#ffffff" }}>Acceso restablecido</h4>
